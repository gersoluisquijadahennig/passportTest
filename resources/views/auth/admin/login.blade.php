        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-header title text-center">
                    Acceso único a sistemas del SSBB ADMINISTRADORES
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('login.admin') }}" novalidate onsubmit="cleanRut()">
                        @csrf
                        <div class="row mb-3">
                            <label for="rut" class="col-md-4 col-form-label text-md-end">R.u.t</label>
                            <div class="col-md-6">
                                <input
                                    id="rut"
                                    type="text"
...
<script>
    ...
    function cleanRut() {
        var runInput = document.getElementById('rut');
